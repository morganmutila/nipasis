...
<nav
    class="bg-[#222222] border-b border-[#222222] shadow-lg px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
            ...
            <a href="{{ route('dashboard') }}" class="flex items-center justify-between mr-4">
                <x-logo-sm />
                <span
                    class="self-center text-lg font-semibold whitespace-nowrap text-white dark:text-white uppercase">Nipa
                    sis</span>
            </a>
        ...
        <div class="flex items-center lg:order-2">
            ...
            <button type="button" data-drawer-toggle="drawer-navigation" aria-controls="drawer-navigation"
                class="p-2 mr-1 text-gray-500 rounded-lg hover:text-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-600">
            ...
            <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                id="dropdown">
                <div class="py-3 px-4">
                    <span class="block text-sm font-semibold text-gray-900 dark:text-white" x-data="{{ json_encode(['name' => auth()->user()->name]) }}"
                ...
                <div class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                    <button type="button" wire:click="logout"
                        class="w-full text-start py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Log
                        out</button>
                </div>
            </div>
        </div>
